...
- PASS live_canonical_url: Canonical points to https://neon-lane-dash.pages.dev/.
...
- Standalone hosting keeps ads disabled, while Playgama builds can run certified interstitial ads at natural run breaks.
