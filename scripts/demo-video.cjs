...
const output = path.join(reports, "neon-lane-dash-demo.mp4");
...
const result = spawnSync("ffmpeg", [
  ...
  concatFile,
  "-vf",
  "scale=720:1280:force_original_aspect_ratio=decrease,pad=720:1280:(ow-iw)/2:(oh-ih)/2:color=101820,fps=24",
  "-c:v",
  "libx264",
  "-pix_fmt",
  "yuv420p",
