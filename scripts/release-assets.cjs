...
const releaseName = "Neon Lane Dash Platform Submission Pack";
const reportPath = path.join(root, "reports", "release-assets.json");
const assets = [
  { file: "reports/neon-lane-dash-html5.zip", label: "HTML5 ZIP package for itch.io and platform upload" },
  ...
  { file: "reports/neon-lane-dash-gamesnacks.zip", label: "GameSnacks-ready ZIP with game.json, SDK-only adapter, and marketing assets" },
  { file: "reports/gamesnacks-package.json", label: "GameSnacks package manifest and upload notes" },
  { file: "reports/gamesnacks-verification.json", label: "GameSnacks SDK, storage, no-external-request, and image-size verification" },
  ...
  { file: "reports/neon-lane-dash-icon-512.png", label: "512x512 platform icon" },
  { file: "reports/neon-lane-dash-cover-16x9.png", label: "1280x720 platform cover image" },
  { file: "reports/neon-lane-dash-social-card.png", label: "1200x630 social preview card" },
...
function releaseBody() {
  return [
    "Submission-ready package for Neon Lane Dash, a free HTML5 reflex game for zero-domain platform-ad validation.",
    "",
    "Live game: https://neon-lane-dash.pages.dev/",
    "Metrics endpoint: https://neon-lane-dash.pages.dev/api/metrics",
    "",
    "Included assets:",
    ...
    "- GameSnacks ZIP uses a separate GameSnacks-only adapter with SDK storage, ads, audio, score, pause/resume, firstFrameReady, and ready hooks.",
...
function githubHeaders() {
  ...
  return {
    ...
    "User-Agent": "NeonLaneDash-Release",
  };
}
