...
const submission = {
  ...
  platformFields: {
    ...
    playgama: {
      name: "Neon Lane Dash",
      description:
        "A short three-lane reflex arcade game with touch-friendly controls, clean score feedback, and natural game-over ad break placement.",
      ...
      complianceNotes: [
        ...
        "External submission-kit CTA is hidden in Playgama context.",
      ],
    },
    gamePix: {
      name: "Neon Lane Dash",
      description:
        "A lightweight HTML5 arcade run with a simple one-more-try loop, local best score, and mobile-friendly controls.",
      ...
      complianceNotes: [
        "Standalone build does not request ads.",
        "External submission-kit CTA is hidden in GamePix context.",
    ...
    gameDistribution: {
      name: "Neon Lane Dash",
      description:
        "A compact HTML5 reflex game with a clear start/replay flow suitable for GameDistribution pre-roll and mid-roll review.",
      ...
      complianceNotes: [
        ...
        "Ad calls are tied to user-triggered start/replay/practice or optional focus actions.",
        "External submission-kit CTA is hidden in GameDistribution context.",
      ],
    },
    itchIo: {
