...
const output = path.join(reports, "neon-lane-dash-html5.tar.gz");
const zipOutput = path.join(reports, "neon-lane-dash-html5.zip");
...
const manifest = {
  ...
  uploadNotes: [
    ...
    "For Yandex Games, use the static build as the web archive and keep SDK-specific ads disabled until accepted.",
